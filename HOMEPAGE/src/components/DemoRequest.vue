      ...
      <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
        ...
        <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
            <a @click="loginAndRedirect('/dashboard')" href="#" class="demo-request-btn"> Get started </a>
...
.demo-request-btn {
    ...
    font-size: 1.25rem;
    font-weight: 700;
    background: linear-gradient(135deg,#ffffff) 90%, #3c3179 10%;
    color: rgba(26, 21, 21, 0.599);
    border: 1px solid rgba(26, 21, 21, 0.599);
    border-radius: 12px;
    cursor: pointer;
    transition: all 0.3s ease;
    box-shadow: 0 4px 20px #2e2662;
    margin-bottom: 3rem;

}
.demo-request-btn:hover {
    background: linear-gradient(135deg, #ffffff 10%, #3c3179 90%);
    color: #1a1515;
    box-shadow: 0 6px 24px #2e2662;
...
import { loginAndRedirect } from '@/store/auth';
